...
INSERT INTO `virtual_library`.`books` (`idbooks`, `id_author`, `title`, `publish_date`, `ISBN`, `publisher`, `add_date`, `synopsis`, `image`, `text`, `category`, `mark`) VALUES (6, 5, 'The Prisoner of Azkaban', ' June 26rd 1997', 9780688120501, 'Bloomsbury Publishing', NULL, '', '/images/harry_potter_3.jpeg', '/src/ThePrisonerOfAzkaban.epub', 5, 0);
